Feature: Gestion des joueurs
    ...
    Scenario: Créer un nouveau joueur
    ...
    Scenario: Associer un joueur à un événement
    ...
    Scenario: Lister les joueurs d'un événement
    ...
    Scenario: Désassocier tous les joueurs d'un événement
