Feature: Déroulement d'une partie de loto
    ...
    Scenario: Tirer un numéro pendant une partie
    ...
    Scenario: Tirer plusieurs numéros
        Étant donné que la partie d'ordre 1 est en statut "RUNNING"
    ...
    Scenario: Annuler le dernier numéro tiré
        Étant donné que la partie d'ordre 1 est en statut "RUNNING"
    ...
    Scenario: Démarquer tous les numéros d'une partie
        Étant donné que la partie d'ordre 1 est en statut "RUNNING"
    ...
    Scenario: Réinitialiser tous les tirages d'un événement
        Étant donné que la partie d'ordre 1 est en statut "RUNNING"
        Et que les numéros "5,12,23" ont été tirés pour la partie d'ordre 1
    ...
    Scenario: Transférer les tirages à la partie suivante
        Étant donné que la partie d'ordre 1 est en statut "RUNNING"
    ...
    Scenario: Empêcher de tirer un numéro si la partie est gelée
        Étant donné que la partie d'ordre 1 est en statut "RUNNING"
